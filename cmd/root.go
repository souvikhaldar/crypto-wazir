...
var baseURL string = "https://api.wazirx.com"

// rootCmd represents the base command when called without any subcommands
var rootCmd = &cobra.Command{
	Use:   "cw",
	Short: "Crypto-Wazir (cw) is CLI for tracking cryptocurrency prices",
	Long:  ``,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&cryptoName, "crypto", "c", "", "name of the cryptocurrency. Eg. btc,eth,etc")
